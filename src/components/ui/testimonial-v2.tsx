            ...
            <React.Fragment key={index}>
              {props.testimonials.map(({ text, image, name, role }, i) => (
                <motion.li 
                  ...
                  className="p-8 rounded-3xl border border-foreground/10 shadow-lg shadow-black/5 max-w-xs w-full bg-background transition-all duration-300 cursor-default select-none group focus:outline-none focus:ring-2 focus:ring-primary/30" 
                >
                  <blockquote className="m-0 p-0">
                    <p className="text-foreground/80 leading-relaxed font-medium m-0 transition-colors duration-300">
                      "{text}"
                    </p>
                    <footer className="flex items-center gap-3 mt-6">
                      <img
                        ...
                        src={image}
                        alt={`Avatar of ${name}`}
                        className="h-10 w-10 rounded-full object-cover ring-2 ring-foreground/5 group-hover:ring-primary/30 transition-all duration-300 ease-in-out"
                        loading="lazy"
                      />
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs leading-5 tracking-tight text-foreground/50 mt-0.5 transition-colors duration-300">
                          {role}
                        </span>
                      </div>
                    </footer>
